...
<html>
    ...
    <body>
       <nav class="top-menu">
                   <ul class="menu-main">
                   <form name="FormOne" method="POST" action="${pageContext.request.contextPath}/controller?command=to-authorized-home">
                     ...
                     <ul>
                      ...
                      <form name="FormTwo" method="POST" action="${pageContext.request.contextPath}/controller?command=log-out">
                      <input type="hidden" name="sign-in" value="sing-in">
                     <li class="right-item">
                          <a href="javascript:document.FormTwo.submit()">
                              <fmt:message key="local.log_out" />
                          </a>
                     </li>
                     </form>
